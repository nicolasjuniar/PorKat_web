...
$route['transaksi']='TransaksiWebController/setTransaksiView';
$route['transaksi/reject/(:num)']['GET']='TransaksiWebController/rejectTransaksi/$1';
$route['transaksi/confirm/(:num)']['GET']='TransaksiWebController/confirmTransaksi/$1';
